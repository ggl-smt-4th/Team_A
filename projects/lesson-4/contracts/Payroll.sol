...
contract Payroll is Ownable{
    ...
    modifier onlyEmployeeNotExists(address employeeId){
        var employee = employees[employeeId];
        require(employee.addr == 0x0);
        _;
    }
    ...
    function addEmployee(address employeeId, uint salary) public onlyOwner onlyEmployeeNotExists(employeeId) {
